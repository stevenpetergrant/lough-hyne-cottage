...
export async function registerRoutes(app: Express): Promise<Server> {
  // Serve authentic Lough Hyne Cottage images from attached assets
  app.use('/api/images', express.static(path.join(process.cwd(), 'attached_assets')));
  
  // Image serving endpoints for authentic cottage photos
  app.get("/api/images/hero-background", (req, res) => {
    res.sendFile(path.join(process.cwd(), 'attached_assets', '875e18f0-63ff-403a-96b2-00b46f716b15.jpg'));
  });

  app.get("/api/images/cottage-exterior", (req, res) => {
    res.sendFile(path.join(process.cwd(), 'attached_assets', '875e18f0-63ff-403a-96b2-00b46f716b15.jpg'));
  });

  app.get("/api/images/cabin-deck", (req, res) => {
    res.sendFile(path.join(process.cwd(), 'attached_assets', '20240828_112944.jpg'));
  });

  app.get("/api/images/lough-sunset", (req, res) => {
    res.sendFile(path.join(process.cwd(), 'attached_assets', '299595f2-bc99-44f7-9ff6-b8e1841f403b.jpg'));
  });

  app.get("/api/images/cabin-interior", (req, res) => {
    res.sendFile(path.join(process.cwd(), 'attached_assets', '1fcdcbe1-8e25-4379-8348-5cf861dcb9a9.avif'));
  });

  app.get("/api/images/aerial-view", (req, res) => {
    res.sendFile(path.join(process.cwd(), 'attached_assets', '7a9c92b2-d126-400f-80d1-e94fefe359df.avif'));
  });

  app.get("/api/images/deck-overlook", (req, res) => {
    res.sendFile(path.join(process.cwd(), 'attached_assets', '47f2fc56-77da-4be3-ac46-28261dc0e195-1.avif'));
  });

  app.get("/api/images/outdoor-spaces", (req, res) => {
    res.sendFile(path.join(process.cwd(), 'attached_assets', '47f2fc56-77da-4be3-ac46-28261dc0e195.avif'));
  });

  app.get("/api/images/cottage-amenities", (req, res) => {
    res.sendFile(path.join(process.cwd(), 'attached_assets', '0065e263-1c66-4e24-ac8d-7e970e07c613.avif'));
  });

  app.get("/api/images/living-spaces", (req, res) => {
    res.sendFile(path.join(process.cwd(), 'attached_assets', '952f61ad-3790-4119-9d33-e66172515cd5.avif'));
  });

  app.get("/api/images/property-facilities", (req, res) => {
    res.sendFile(path.join(process.cwd(), 'attached_assets', '40755218-51a7-4bac-8253-f0945d021716.avif'));
  });

  app.get("/api/images/waterfront-views", (req, res) => {
    res.sendFile(path.join(process.cwd(), 'attached_assets', '7a9c92b2-d126-400f-80d1-e94fefe359df.avif'));
  });

  app.get("/api/images/natural-surroundings", (req, res) => {
    res.sendFile(path.join(process.cwd(), 'attached_assets', '31d30d30-f0ad-4f30-948b-750ffef9b695.avif'));
  });

  app.get("/api/images/cottage-features", (req, res) => {
    res.sendFile(path.join(process.cwd(), 'attached_assets', '3e6384b4-52b2-4806-a231-cfeac7f37ecd.avif'));
  });

  app.get("/api/images/scenic-views", (req, res) => {
    res.sendFile(path.join(process.cwd(), 'attached_assets', 'fc4dfcd6-c8fe-489e-a579-b1dd9cbb58fc.avif'));
  });

  app.get("/api/images/cottage-experience", (req, res) => {
    res.sendFile(path.join(process.cwd(), 'attached_assets', 'fef784d5-721e-4814-939c-9d3ce871e60d.avif'));
  });
