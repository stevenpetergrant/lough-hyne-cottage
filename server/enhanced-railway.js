...
// Root route serves the authentic Lough Hyne Cottage website
app.get('/', (req, res) => {
  res.status(200).send(`
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Lough Hyne Cottage - Eco Luxury in Ireland's Marine Nature Reserve</title>
    <meta name="description" content="Experience sustainable luxury at Lough Hyne Cottage, Ireland's first marine nature reserve. Book cabin stays, sauna sessions, yoga retreats and bread making workshops in beautiful West Cork.">
...
<body>
        ...
        <div class="container">
            <div class="hero-content flex items-center justify-between">
                ...
                <div class="hero-image flex-1">
                    <img src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600" 
                         alt="Lough Hyne Marine Nature Reserve aerial view" 
    ...
    <!-- Accommodation -->
    <section id="accommodation" class="bg-white section-padding">
        <div class="container">
            <div class="flex items-center justify-between mb-16">
                <div class="flex-1 pr-12">
                    <h2 class="text-4xl font-accent font-semibold text-forest mb-6">Authentic Irish Cottage Experience</h2>
                    <p class="text-lg text-gray-700 mb-8 leading-relaxed">
                        Our beautifully restored cottage combines traditional Irish charm with modern comfort. 
                        Wake up to stunning lake views, enjoy locally sourced breakfasts, and experience the tranquility 
                        of this unique marine sanctuary.
                    </p>
                    <div class="space-y-4 mb-8">
                        <div class="flex items-center">
                            <span class="w-2 h-2 bg-sage rounded-full mr-3"></span>
                            <span>Panoramic views of Lough Hyne</span>
                        </div>
                        <div class="flex items-center">
                            <span class="w-2 h-2 bg-sage rounded-full mr-3"></span>
                        ...
                        <div class="flex items-center">
                            <span class="w-2 h-2 bg-sage rounded-full mr-3"></span>
                            <span>Private garden and outdoor seating</span>
                        </div>
                        <div class="flex items-center">
                            <span class="w-2 h-2 bg-sage rounded-full mr-3"></span>
                ...
                <div class="flex-1">
                    <img src="https://images.unsplash.com/photo-1582719471384-894fbb16e074?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=450" 
                         alt="Lough Hyne Cottage exterior" 
    ...
    <!-- Experiences -->
    <section id="experiences" class="bg-cream section-padding">
        <div class="container">
    ...
    <section id="booking" class="bg-forest text-white section-padding">
        <div class="container">
            <div class="text-center mb-12">
                <h2 class="text-4xl font-accent font-semibold mb-6">Book Your Retreat</h2>
                <p class="text-xl opacity-90 max-w-2xl mx-auto">
                    Start your journey to Ireland's most unique and peaceful destination. We'll respond within 24 hours to confirm your stay.
                </p>
            </div>
    ...
    <section id="contact" class="bg-white section-padding">
        <div class="container">
            <div class="text-center mb-12">
                <h2 class="text-4xl font-accent font-semibold text-forest mb-6">Visit Us</h2>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-start">
                ...
                <div class="bg-cream p-6 rounded-2xl">
                    <img src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400" 
                         alt="Map of Lough Hyne location in West Cork" 
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div>
                    ...
                    <p class="text-gray-300 leading-relaxed">
                        Experience sustainable luxury in Ireland's first marine nature reserve. 
                        Authentic hospitality in West Cork's most unique setting.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-2 text-gray-300">
                        ...
                        <p>Lough Hyne, Skibbereen, Cork</p>
                        <p>Ireland P81 P984</p>
                    </div>
                </div>
            </div>
            
            <div class="border-t border-gray-600 mt-8 pt-8 text-center text-gray-300">
                <p>&copy; 2025 Lough Hyne Cottage. Supporting conservation and sustainable tourism in West Cork.</p>
            </div>
        </div>
    </footer>
    ...
    <script>
        ...
        document.getElementById('bookingForm').addEventListener('submit', function(e) {
            ...
            alert('Thank you for your booking request! We will contact you within 24 hours to confirm your stay and provide payment details. We look forward to welcoming you to Lough Hyne Cottage.');
            this.reset();
            updateTotal();
        });
