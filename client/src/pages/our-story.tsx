      ...
      <div className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
            ...
            <div className="my-8">
              <img 
                src="https://loughhynecottage.com/wp-content/uploads/2024/09/20240607_164055.jpg" 
          ...
          <div className="mb-8">
            <img 
              src="https://loughhynecottage.com/wp-content/uploads/2024/09/our-story-1.jpg" 
